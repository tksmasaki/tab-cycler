...
// Re-injection via chrome.scripting.executeScript can re-run this module in the
// same realm. Bail out early so we don't double-register listeners or stack a
// second overlay host on the page.
if (!window.__tabCyclerInjected) {
